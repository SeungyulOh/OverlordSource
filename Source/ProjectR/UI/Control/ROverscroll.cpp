...
FROverscroll::FROverscroll()
	: OverscrollAmount(0.0f)
{
}

float FROverscroll::ScrollBy(float Delta)
{
...
float FROverscroll::GetOverscroll() const
{
...
void FROverscroll::UpdateOverscroll(float InDeltaTime)
{
...
bool FROverscroll::ShouldApplyOverscroll(const bool bIsAtStartOfList, const bool bIsAtEndOfList, const float ScrollDelta) const
{

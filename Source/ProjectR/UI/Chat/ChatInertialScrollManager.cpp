...
#include "ProjectR.h"
#include "ChatInertialScrollManager.h"


FChatInertialScrollManager::FChatInertialScrollManager(float InScrollDecceleration, double InSampleTimeout)
...
void FChatInertialScrollManager::AddScrollSample(float Delta, double CurrentTime)
{
...
void FChatInertialScrollManager::UpdateScrollVelocity(const float InDeltaTime)
{
...
void FChatInertialScrollManager::ClearScrollVelocity()
{
	this->ScrollVelocity = 0;
}
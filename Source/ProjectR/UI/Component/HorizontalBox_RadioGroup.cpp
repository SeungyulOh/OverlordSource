...
#include "HorizontalBox_RadioGroup.h"

#include "UI/RBaseWidget.h"

void UHorizontalBox_RadioGroup::SynchronizeProperties()
{
	...
	for (UPanelSlot* PanelSlot : Slots)
	{
		...
		RadioButton->RadioGroupoComponentStateChanged.BindDynamic(this, &UHorizontalBox_RadioGroup::RadioGroupoComponentStateChanged);
	}
}

void UHorizontalBox_RadioGroup::RadioGroupoComponentStateChanged(int32 UniqueID, bool bIsChecked)
{
	int32 CheckIdx = 0;
	int32 UnCheckIdx = 1;
...
void UHorizontalBox_RadioGroup::SetActiveRadioIndex(int32 InIndex, bool bEvent)
{
	int32 CheckIndex = 0;
	int32 CheckIdx = 0;
	int32 UnCheckIdx = 1;

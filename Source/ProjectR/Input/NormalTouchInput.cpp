...
#include "ProjectR.h"
#include "NormalTouchInput.h"
#include "GameFramework/PlayerInput.h"


UNormalTouchInput::UNormalTouchInput(const FObjectInitializer& ObjectInitializer)
...
void UNormalTouchInput::UpdateDetection(float DeltaTime)
{
	UpdateGameKeys(DeltaTime);
	ProcessKeyStates(DeltaTime);
}

void UNormalTouchInput::ProcessKeyStates(float DeltaTime)
{
...
void UNormalTouchInput::UpdateGameKeys(float DeltaTime)
{
...
void UNormalTouchInput::DetectOnePointActions(bool bCurrentState, bool bPrevState, float DeltaTime, const FVector2D& CurrentPosition, FVector2D& AnchorPosition, float& DownTime)
{
...
void UNormalTouchInput::DetectTwoPointsActions(bool bCurrentState, bool bPrevState, float DeltaTime, const FVector2D& CurrentPosition1, const FVector2D& CurrentPosition2)
{
...
FVector2D UNormalTouchInput::GetTouchAnchor(int32 i) const
{
